...
<!-- Bootstrap styles -->
<link rel="stylesheet"
	href="/js/file-upload/bootstrap-3.2.0/css/bootstrap.min.css">
<!-- Generic page styles -->
<link rel="stylesheet" href="/js/file-upload/css/style.css">
<!-- blueimp Gallery styles -->
<link rel="stylesheet"
	href="/js/file-upload/gallery/css/blueimp-gallery.min.css">
<!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
<link rel="stylesheet" href="/js/file-upload/css/jquery.fileupload.css">
<link rel="stylesheet"
	href="/js/file-upload/css/jquery.fileupload-ui.css">
<!-- CSS adjustments for browsers with JavaScript disabled -->
<noscript>
	<link rel="stylesheet"
		href="/js/file-upload/css/jquery.fileupload-noscript.css">
</noscript>
<noscript>
	<link rel="stylesheet"
		href="/js/file-upload/css/jquery.fileupload-ui-noscript.css">
</noscript>
</head>
<body>
	<div class="container">
		<form id="fileupload" action="/rest/pic/upload" method="POST"
			...
			<div class="row fileupload-buttonbar">
				<div class="col-lg-7">
					...
					<span class="btn btn-success fileinput-button"> <i
						class="glyphicon glyphicon-plus"></i> <span>选择文件(多选)</span> <input
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<ul>
					<li>上传的文件大小限制为：<strong>5 MB</strong>.
					</li>
					<li>只支持的文件格式为：<strong>JPG, GIF, PNG, BMP </strong>.
					</li>
				</ul>
			</div>
		</div>
